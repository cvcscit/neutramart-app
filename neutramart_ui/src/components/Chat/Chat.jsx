...
export default function Chat() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Hi! I'm your NutraSmart AI assistant. Ask me anything about your eating habits, nutrition, or diet recommendations." },
  ]);
  ...
  if (!open) {
    return (
      <button className="chat-fab" onClick={() => setOpen(true)} title="Chat with NutraSmart AI">
        <svg className="chat-fab-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
